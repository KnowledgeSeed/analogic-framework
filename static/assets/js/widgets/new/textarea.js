...
class TextAreaWidget extends Widget {
    ...
    getHtml(widgets, d) {
        ...
        return `<div class="ks-textarea ${mainDivClass.join(' ')} ks-textarea-${v.skin}"  style="${mainDivStyle.join('')}">
    ...
    initEventHandlers(section) {
        section.find('.ks-textarea-input').on('focusout', e => {
            ...
            app.widgetValue[id].value = app.utils.escapeText(w.val());
            w.data('value', app.utils.escapeText(w.val()));
