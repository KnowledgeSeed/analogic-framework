...
(function ($) {
    $.fn.richText = function (options) {
        ...
        var $editor, $toolbarList = $("<ul />"), $toolbarElement = $("<li />"), $btnBold = $("<a />", {
            ...
            html: '<span class="icon-textformat-bold"></span>'
        }), $btnItalic = $("<a />", {
            class: "richText-btn",
            "data-command": "italic",
            title: settings.translations.italic,
            html: '<span class="icon-textformat-italic"></span>'
        }), $btnUnderline = $("<a />", {
            class: "richText-btn",
            "data-command": "underline",
            title: settings.translations.underline,
            html: '<span class="icon-textformat-underline"></span>'
        }), $btnJustify = $("<a />", {
            class: "richText-btn",
            "data-command": "justifyFull",
            title: settings.translations.justify,
            html: '<span class="icon-text-justify"></span>'
        }), $btnLeftAlign = $("<a />", {
            class: "richText-btn",
            "data-command": "justifyLeft",
            title: settings.translations.alignLeft,
            html: '<span class="icon-text-align-left"></span>'
        }), $btnCenterAlign = $("<a />", {
            class: "richText-btn",
            "data-command": "justifyCenter",
            title: settings.translations.alignCenter,
            html: '<span class="icon-text-align-right"></span>'
        }), $btnRightAlign = $("<a />", {
            class: "richText-btn",
            "data-command": "justifyRight",
            title: settings.translations.alignRight,
            html: '<span class="icon-text-align-center"></span>'
        }), $btnOL = $("<a />", {
            class: "richText-btn",
            "data-command": "insertOrderedList",
            title: settings.translations.addOrderedList,
            html: '<span class="icon-list-number"></span>'
        }), $btnUL = $("<a />", {
            class: "richText-btn",
            ...
            html: '<span class="icon-abc"></span>'
        }), $btnFont = $("<a />", {
            class: "richText-btn",
            title: settings.translations.addFont,
            html: '<span class="icon-a-cursor-ibeam"></span>'
        }), $btnFontColor = $("<a />", {
            class: "richText-btn",
            title: settings.translations.addFontColor,
            html: '<span class="icon-timeline"></span>'
        }), $btnBackgroundColor = $("<a />", {
            class: "richText-btn",
            title: settings.translations.addBackgroundColor,
            html: '<span class="icon-text-highlight"></span>'
        }), $btnFontSize = $("<a />", {
            class: "richText-btn",
            ...
            html: '<span class="icon-doc-text-image"></span>'
        }), $btnVideoEmbed = $("<a />", {
            class: "richText-btn",
            title: settings.translations.addVideo,
            html: '<span class="icon-icon-video></span>'
        }), $btnFileUpload = $("<a />", {
            class: "richText-btn",
            title: settings.translations.addFile,
            html: '<span class="icon-doc"></span>'
        }), $btnURLs = $("<a />", {
            class: "richText-btn",
        ...
        function init() {
            ...
            if (!settings.preview && settings.undoRedo) {
                $bottomToolbar.append($("<a />", {
                    ...
                    html: '<span class="icon-arrow-reset-circle"></span>',
            ...
            $bottomToolbar.append($("<a />", {
                class: "richText-help",
                html: '<span class="icon-question-bubble"></span>'
            }));
        ...
        settings.$editor.find(".richText-help").on("click", function () {
            ...
            if ($editor) {
                ...
                var $content = $("<div />", {html: '<span id="closeHelp" style="display:block;position:absolute;top:0;right:0;padding:10px;cursor:pointer;" title="' + settings.translations.close + '"><span class="icon-close-circle"></span></span>'});
        ...
        settings.$editor.find(".richText-editor").on("contextmenu", ".richText-editor", (e) => {
            ...
            if ($target.prop("tagName") === "A") {
                e.preventDefault();
                $list.append($li.clone().html('<span class="icon-link"></span>'));
                $target.parents(".richText").append($list);
                $list.find(".icon-link").on("click", function () {
                    ...
                    $toolbar.find(".richText-btn").children(".icon-link").parents("li").addClass("is-selected")
                });
                return false
            } else if ($target.prop("tagName") === "IMG") {
                e.preventDefault();
                $list.append($li.clone().html('<span class="icon-doc-text-image"></span>'));
                $target.parents(".richText").append($list);
                $list.find(".icon-doc-text-image").on("click", function () {
                    var align;
                    ...
                    $toolbar.find(".richText-btn").children(".icon-doc-text-image").parents("li").addClass("is-selected")
                });
                return false
            }
        });
        ...
        $(document).on("click", function (event) {
            ...
            if ($clickedElement.parents(".richText-toolbar").length === 0) {
                ...
                if ($clickedElement.hasClass("icon-link")) {
                    restoreSelection(editorID, false, true);
                ...
                } else if ($clickedElement.hasClass("icon-doc-text-image")) {
                }
            }
        });
        ...
        function toggleCode(editorID) {
            ...
            if ($editor.find(".richText-editor").is(":visible")) {
                ...
                $(".richText-toolbar").find(".richText-btn").each(function () {
                    if ($(this).children(".icon-ellipsis-rectangle-fill").length === 0) {
