...
<div class="ks-chart-holder" style="${this.getGeneralStyles(d).join('')}">
    ...
    initEventHandlers() {
        ...
        c.parent().next().on('click', '.ChartLegendTag', e => {
            ...
            const id = e.data('id'), isHidden = !chart.isDatasetVisible(id), c = this.value.datasets[id].color;
    ...
    getChartConfig() {
        const data = [], xEdges = [], v = this.value, selectedDatasetIds = [], datasets = v.datasets, verticalLineXCoords = [], id = this.id;
        ...
        let e, f, yMin = Infinity, yMax = -Infinity, c, d, r, o, i, hasSelectedDataset = selectedDatasetIds.length > 0;
        ...
        return {
            ...
            options: {
                ...
                onDragStart: (e, element) => {
                    if (element._chart.data.datasets[element._datasetIndex].static) {
                        return false;
                    }
                },
